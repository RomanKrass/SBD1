...
When we look at the STL decomposition we can see, that the sesonal part is very low because it was already removed in the data. We can also see that there is a negative trend in most of the time series. This means that the saving rate decreased over time. The remainder is the part that is left after removing the seasonal and trend part. This part is the part that is not explained by the trend and the seasonal part. 
We can see that the remainder is white noise because it doens't have any trend or pattern to it . But when we look at the results from our other plots we can explain the last extreme variation in the remainder. This is the COVID-19 pandemic.
